    ...
    <main className="min-h-screen flex items-center justify-center py-16 px-4">
      <div className="max-w-md w-full">
        <div className="glass-card p-8 rounded-2xl">
          ...
          <p className="mt-2 text-gray-600">You are not signed in. <Link href="/login" className="text-primary">Log in</Link> or <Link href="/signup" className="text-primary">Sign up</Link>.</p>
        </div>
      </div>
    </main>
  )
      ...
      <div className="max-w-2xl w-full">
        <div className="glass-card p-8 rounded-2xl">
          ...
          <form onSubmit={onSubmit} className="mt-6 grid grid-cols-1 gap-4">
            <div className="flex items-center gap-4">
              <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center border-2 border-gray-200">
                {(avatarPreview || avatar) ? (
                  ...
                  <div className="text-gray-500 text-sm text-center">No photo</div>
                )}
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">New password <span className="text-xs text-gray-400">(leave blank to keep current)</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Job role preferences</label>
