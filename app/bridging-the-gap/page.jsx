  ...
  const fetchAnalysis = async () => {
    try {
      ...
      if (fullAnalysis.roadmap?.steps && Array.isArray(fullAnalysis.roadmap.steps)) {
        ...
        setRoadmapData(skillRoadmap)
        console.log('✅ Roadmap structured:', Object.keys(skillRoadmap).length, 'skills')
      } else {
