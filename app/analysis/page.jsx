    ...
    return (
      <main className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'Could not load resume analysis'}</p>
    ...
    <main className="min-h-screen">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Resume Skill Match Result</h1>
            <p className="mt-1 text-sm text-gray-600">AI-powered analysis based on your uploaded resume</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              <CircularProgress percentage={data.matchPercent} />
            </div>
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                Your resume matches {data.matchPercent}% of the required skills
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Based on our AI analysis, you have a strong foundation. Focus on the missing skills below to increase your match score and improve your chances.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
                <div className="flex items-center gap-2 text-sm">
                  <div className="w-3 h-3 rounded-full bg-green-500"></div>
                  <span className="text-gray-600">{data.skillsFound.length} Skills Found</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <span className="text-gray-600">{data.missingSkills.length} Skills Missing</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Great! You have these skills</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Work on these to improve your score</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
