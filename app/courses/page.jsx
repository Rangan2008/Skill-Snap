    ...
    <main className="min-h-screen py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="glass-card p-6 rounded-2xl">
          ...
          <p className="mt-2 text-gray-600">No active course found. Visit the Dashboard to pick one.</p>
          <div className="mt-4">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="glass-card p-6 rounded-2xl">
          ...
          <div className="mt-4">
            ...
            <div className="mt-3 text-sm text-gray-600">{updating ? 'Updating progress while you learn…' : 'Progress saved'}</div>
          </div>
