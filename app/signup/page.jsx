    ...
    <main className="min-h-screen flex items-center justify-center py-16 px-4">
      <div className="max-w-md w-full">
        <div className="glass-card p-8 rounded-2xl shadow-md">
          ...
          <p className="mt-2 text-gray-600">Start tracking your resume and skill growth.</p>
          ...
          <form className="mt-6 space-y-4" onSubmit={onSubmit} aria-label="Sign up form">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <button type="button" aria-label={showPassword ? 'Hide password' : 'Show password'} onClick={()=> setShowPassword(s=>!s)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <button type="button" aria-label={showConfirm ? 'Hide password' : 'Show password'} onClick={()=> setShowConfirm(s=>!s)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600">
