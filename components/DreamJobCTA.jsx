      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="glass-card p-6 sm:p-10 rounded-2xl flex flex-col sm:flex-row items-center gap-6">
          <div className="sm:w-1/2">
            ...
            <p className="mt-3 text-gray-600">Analyze your resume to discover targeted skill gaps and get a clear learning roadmap to your target role.</p>
            <div className="mt-6">
              <button onClick={onAnalyze} className="animated-btn animated-btn--primary">Analyze Your Resume</button>
            </div>
          </div>

          <motion.div className="sm:w-1/2 flex justify-center" initial={{opacity:0, y:10}} whileInView={{opacity:1, y:0}} viewport={{once:true}}>
            <Image src="/illustration.svg" alt="Illustration" width={360} height={240} className="rounded-xl shadow-soft-lg" />
          </motion.div>
        </div>
      </div>
    </section>
