...
export default function Hero(){
  ...
  const onFileChange = (e)=>{
    ...
    if(!f) return
    // Placeholder functionality — replace with backend integration later
    alert(`Selected file: ${f.name}`)
    console.log('File uploaded (placeholder):', f)
  }
  ...
  return (
    <section id="home" className="mt-30 py-20 min-h-[72vh] flex items-center">
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <motion.p initial={{y:8,opacity:0}} animate={{y:0,opacity:1}} transition={{ delay:0.08 }} className="mt-3 text-xl text-gray-600">Upload your resume and get a personalized roadmap matched to your dream role — skills to learn, resources, and next steps.</motion.p>
